...
--
-- Host: localhost:3306
-- Generation Time: Apr 08, 2021 at 11:07 AM
...
(1, '127.0.0.1', 'muluk.dharmayana@gmail.com', 1, '2021-03-29 10:57:32', 0),
(2, '127.0.0.1', 'muluk.dharmayana@gmail.com', 1, '2021-03-29 10:58:02', 1),
(3, '127.0.0.1', 'muluk.dharmayana@gmail.com', NULL, '2021-03-30 07:15:26', 0),
(4, '127.0.0.1', 'muluk.dharmayana@gmail.com', NULL, '2021-03-30 07:15:56', 0),
(5, '127.0.0.1', 'muluk.dharmayana@gmail.com', NULL, '2021-03-30 07:16:18', 0),
(6, '127.0.0.1', 'muluk.dharmayana@gmail.com', NULL, '2021-03-30 07:16:37', 0);
...
(1, '2017-11-20-223112', 'Myth\\Auth\\Database\\Migrations\\CreateAuthTables', 'default', 'Myth\\Auth', 1617028973, 1);
...
CREATE TABLE `ref_kab_kota` (
  ...
  `id_ref_provinsi` char(2) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `nama` tinytext CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `id_ref_jenis_daerah` int NOT NULL
...
INSERT INTO `ref_kab_kota` (`id`, `id_ref_provinsi`, `nama`, `id_ref_jenis_daerah`) VALUES
...
CREATE TABLE `ref_kecamatan` (
  ...
  `id_ref_kab_kota` char(4) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `nama` tinytext CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci ROW_FORMAT=DYNAMIC;
...
INSERT INTO `ref_kecamatan` (`id`, `id_ref_kab_kota`, `nama`) VALUES
...
INSERT INTO `ref_provinsi` (`id`, `nama`) VALUES
('11', 'Aceh'),
('12', 'Sumatera Utara'),
('13', 'Sumatera Barat'),
('14', 'Riau'),
...
ALTER TABLE `ref_kab_kota`
  ...
  ADD KEY `id_ref_provinsi` (`id_ref_provinsi`) USING BTREE,
  ADD KEY `id_ref_jenis_daerah` (`id_ref_jenis_daerah`) USING BTREE;
...
ALTER TABLE `ref_kecamatan`
  ADD PRIMARY KEY (`id`) USING BTREE,
  ADD KEY `id_ref_kab_kota` (`id_ref_kab_kota`) USING BTREE;
...
--
ALTER TABLE `ref_kab_kota`
  ADD CONSTRAINT `ref_kab_kota_ibfk_1` FOREIGN KEY (`id_ref_provinsi`) REFERENCES `ref_provinsi` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  ADD CONSTRAINT `ref_kab_kota_ibfk_2` FOREIGN KEY (`id_ref_jenis_daerah`) REFERENCES `ref_jenis_daerah` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE;

--
-- Constraints for table `ref_kecamatan`
--
ALTER TABLE `ref_kecamatan`
  ADD CONSTRAINT `ref_kecamatan_ibfk_1` FOREIGN KEY (`id_ref_kab_kota`) REFERENCES `ref_kab_kota` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
COMMIT;
